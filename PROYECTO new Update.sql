-- Creation of the database.
 ...
 Us_Id int,
 T_NAME VARCHAR (30),
 FOREIGN KEY (Us_Id) REFERENCES PLAYER (Us_Id)on update cascade on delete cascade,
 FOREIGN KEY (T_NAME) REFERENCES TROPHYE (T_NAME)on update cascade on delete cascade,
 ...
 SCORE int DEFAULT 0,
 FOREIGN KEY (Us_Id) REFERENCES PLAYER (Us_Id)on update cascade on delete cascade,
 FOREIGN KEY (G_NAME) REFERENCES GAME (G_NAME)on update cascade on delete cascade
 );
 ...
 INSERT INTO PLAYS(Us_ID, G_Name, DATI, SCORE) VALUES (2, 'AIM', '2024-12-12', 20),
 (3, 'AIM', '2025-01-05', 30);
